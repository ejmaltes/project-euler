...
def findProduct():
    ...
    max.append(checkRows(grid))
    max.append(checkColumns(grid))
    max.append(checkDownRight(grid))
    max.append(checkDownLeft(grid))
